...
function clickedStar(event){
    ...
    if(event.srcElement.attributes[0].value == "../img/unfav.png")
    {
        ...
        fetch("../PHP/delete.php?q=" + encodeURIComponent(ID) + "-----" + encodeURIComponent(Funzione));
...
document.querySelector("#menu").addEventListener("click", apriMenu);
