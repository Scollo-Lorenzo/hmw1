...
<html>
    ...
    <head>
        ...
        <title> Lista PREFERITI di <?php echo $_SESSION["username"]; ?> </title>
		...
		<script src="../JS/listaPreferiti.js?v=<?php echo time(); ?>"/ defer="true"></script>
    ...
    <body>
        ...
        <main>
                    ...
                    <div id="header">
                        ...
                        Lista PREFERITI di: <h1> <?php echo $_SESSION["username"]; ?> </h1> Totale: <h1 id="Totale"> </h1>
